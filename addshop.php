                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="position-relative form-group text-center"><label for="exampleSelect" class="">รูปที่ 1 : Profile</label>
                                                            ...
                                                            <div class="custom-file ml-5">
                                                                ...
                                                                <button class="btn btn-danger" id="noeditimgproduct1" style="height:80% ;font-size: small;" hidden>X</button>
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="position-relative form-group text-center"><label for="exampleSelect" class="">รูปที่ 2 : Banner</label>
                                                            ...
                                                            <div class="custom-file ml-5">
                                                                ...
                                                                <button class="btn btn-danger" id="noeditimgproduct2" style="height:80% ;font-size: small;" hidden>X</button>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
    ...
    <script type="text/javascript" language="javascript">
        $(document).ready(function() {
            ...
            $("#btn0").click(function() {
                ...
                var url = url_global + '/api/v1_0/shop/update'
                // event.preventDefault();
                var form1 = $('#fileAddForm')[0];
